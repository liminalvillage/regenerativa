        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Explore the global network of regenerative communities using H3 fractal cells
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          {/* Features Section */}
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-4">
                    Create and manage fractal and composable communities focused on local resilience.
                  </p>
